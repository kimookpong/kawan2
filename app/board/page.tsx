...
export default async function BoardPage() {
  ...
  const [{ data: categories }, { data: recentThreads }] = await Promise.all([
    ...
    supabase.from("threads")
      .select("id, title, category_id, reply_count, like_count, view_count, created_at, is_pinned, members_only, profiles(username, display_name, level_id), categories(name_th, slug)")
