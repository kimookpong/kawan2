...
export const LEVEL_STYLES: Record<
  number,
  { label: string; en: string; cls: string; name: string }
> = {
  1: {
    label: "รายัต",
    en: "RAKYAT",
  ...
  19: {
    label: "มหาราชา",
    en: "MAHARAJA",
    cls: "bg-purple-700 text-white",
    name: "text-purple-700",
  },
  20: {
    label: "เสรี มหาราชา",
    en: "SERI MAHARAJA",
    cls: "bg-gradient-to-r from-amber-400 to-yellow-500 text-[#0f1b2e]",
    name: "text-amber-600",
  },
};
...
export const ROLE_LABELS: Record<string, { label: string; cls: string }> = {
  ...
  editor: {
    label: "บรรณาธิการ",
    cls: "bg-tertiary-container/15 text-tertiary-container",
  },
